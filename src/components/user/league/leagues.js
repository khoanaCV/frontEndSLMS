...
const LeagueItem = ({ league, onBtnCircleClick }) => {
    ...
    return (
        <Col xs={3} xl={3} lg={4} md={5} sm={12} className={cx('inner_item')}>
            <Card className={cx('item-container')} style={{ width: '18rem', cursor: "pointer", border: "none", boxShadow: "1px 1px 1px 2px #d8d8d8 " }}>
...
const Leagues = () => {
    ...
    const [leagues, setLeagues] = useState([
        // {
        //     id: 1, leagueName: 'FCS1',
        //     type: 'Loại trực tiếp',
        //     numberOfPeople: '7',
        //     user: "Nguyễn Rin",
        //     locationStadium: "Cầu Giấy,Hà Nội",
        //     status: "Đang đăng ký",
        //     star: "9",
        //     numberOfTeam: "10",
        //     view: "20"
                    ...
                    <Col xs={2} style={{ padding: "0", textAlign: "center" }}>
                        <Dropdown>
                            ...
                            <Dropdown.Menu style={{ backgroundColor: 'white', width: "100%", borderColor: '#fd1e50', color: 'black' }}>
                                ...
                                <Dropdown.Item onClick={() => handleTypeChange("Đấu chia bảng")}>Chia bảng đấu</Dropdown.Item>
                            </Dropdown.Menu>
                        </Dropdown>
                    </Col>
                    <Col xs={2} style={{ padding: "0", textAlign: "center" }}>
                ...
                <Row className={cx('body_wrapper')}>
                    <Row className={cx('body_inner')}>
                        {currentTableData.map((league, index) => (
                            <LeagueItem key={index} league={league} onBtnCircleClick={() => handleBtnCircleClick(league.id)} />
                        ))}
