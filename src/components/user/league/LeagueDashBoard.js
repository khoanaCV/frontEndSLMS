...
import { getLeaguesStatisticByTournamentId, getMatchWithMostCardsByTournamentId, getMatchWithMostGoalsByTournamentId, getPlayerWithMostCardByTournamentId, getTeamWithMostCardByTournamentId, getTeamWithMostGoalsByTournamentId } from "../../../services/LeagueSevice";
...
const DashboardComponent = () => {
    ...
    const statistics = [
        ...
        { icon: images.phanluoi, title: 'Số bàn phản lưới', text: `${Leaguestatistics.totalGoals}`, bgColor: '#8e44ad' },
        { icon: images.match, title: 'Tổng số trận đấu', text: `${Leaguestatistics.totalOwnGoals}`, bgColor: '#e26a6a' },
        { icon: images.sumcard, title: 'Tổng số thẻ', text: `${Leaguestatistics.totalCards}`, bgColor: '#578ebe' },
        {
            ...
            body: mostGoal === null ? 'Chưa xác định' : `${mostGoal.startDate}`,
            bgColor: '#36d7b7'
        },
        {
            ...
            body: mostCard === null ? 'Chưa xác định' : `${mostCard.matchDate}`,
            bgColor: '#95a5a6'
        },
                            ...
                            <Row className="league-inner">
                                                                ...
                                                                <Col xs={12} style={{ padding: "20px" }}>
                                                                    <Button href="/league/dashboard/:id/calendarleague" style={{ width: "100%", backgroundColor: "#fd1e50" }}>
                                                                        ...
                                                                        <Link
                                                                            ...
                                                                            to="/league/dashboard/:id/calendarleague">
                                ...
                                <Col xs={6} style={{ padding: "0 10px" }}>
                                    <Row className="league-inner_right" style={{ padding: "20px", display: "flex", alignItems: "center", justifyContent: "end" }}>
                                        {file ? (
                                            <>
                                                <Button variant="primary" href={file} download="LuatThiDau.txt" style={{ marginRight: "10px", width: "200px", backgroundColor: "#fd1e50", border: "none" }}>

                                                    Tải về
                                                </Button>
                                                <Button variant="danger" style={{ marginRight: "10px", width: "200px", backgroundColor: "#fd1e50", border: "none" }} onClick={() => setShowModal(true)}>
                                                    Xóa tệp
                                                </Button>
                                            </>
                                        ) : (
