...
export default function UpdateTeam() {
    ...
    useEffect(() => {
        if (id) {
            getTeamsByTeamId(id)
                .then(data => {
                    if (data && data.logo && data.uniForm1 && data.uniForm2 && data.uniForm3) {
                        ...
                        console.error('Data is undefined or does not have the expected properties.');
                    }
                })
                .catch(error => {
    ...
    const handleUpdateTeam = async (event) => {
        ...
        formData.append('Logo', leagueImage);
        formData.append('UniForm1', leagueImage1);
        formData.append('UniForm2', leagueImage2);
        formData.append('UniForm3', leagueImage3);
